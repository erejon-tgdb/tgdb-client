...
//This test currently requires the Brembo data set
...
//        List valueList = g.V().hasLabel("cdi").and(
		...
		*/
		...
		TGResultSet resultSet = conn.executeQuery("gremlin://g.V().hasLabel('cdi').has('cdiid', '172CDIXDQC18').outE('produces').inV().outE('produces').inV().path();", null);
